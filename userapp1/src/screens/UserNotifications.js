...
const UserNotifications = () => {
  ...
  const fetchNotifications = async () => {
    ...
    const response = await axios.get(`${process.env.BACKENDAIPE}/api/user/notifications`, {
      headers: {
    ...
    <View style={styles.notificationCardContainer}>
      <View style={styles.notificationContainer}>
        <View style={styles.iconContainer}>
          <Text>
          <Icon name="notifications" size={24} color="#ff4500" /> {/* Notification bell icon */}
          </Text>
        </View>
        <View style={styles.notificationContent}>
          ...
          <View style={styles.timeContainer}>
            ...
            <Text style={styles.notificationTime}>{moment(item.receivedat).format('hh:mm A')}</Text>
          </View>
        </View>
        
      </View>
      <Text style={styles.notificationBody}>Commander accepted your request he will be there with in 5 mins</Text>
    </View>
  );
