...
const WorkerNavigationScreen = () => {
  ...
  const checkCancellationStatus = async () => {
    try {
      const response = await axios.get(
        `${process.env.BackendAPI14}/api/worker/cancelled/status`,
        {
  ...
  const fetchAddressDetails = useCallback(async () => {
    try {
      const response = await axios.get(
        `${process.env.BackendAPI14}/api/user/address/details`,
        {
          params: {notification_id: decodedId},
        },
      );
  ...
  const fetchLocationDetails = async () => {
    try {
      const response = await axios.post(
        `${process.env.BackendAPI14}/api/service/location/navigation`,
        {
  ...
  const handleCancelBooking = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.BackendAPI14}/api/worker/work/cancel`,
        {notification_id: decodedId},
      );
